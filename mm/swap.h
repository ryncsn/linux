...
static inline int folio_alloc_swap(struct folio *, gfp_t)
{
}

static inline int folio_dup_swap(struct folio *, struct page *)
{
}

static inline void folio_put_swap(struct folio *, struct page *)
{
}
