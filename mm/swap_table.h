...
/*
 * Helpers for testing swap table entry type
 */
...
/*
 * Helpers for retrieving data from swap table entry
 */
...
{
	VM_BUG_ON(!swp_te_is_shadow(entry));
...
/*
 * Helpers for manipulating swap table entry info without touching count
 */
